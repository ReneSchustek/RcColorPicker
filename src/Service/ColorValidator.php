 ...
 * jeder Eingangskante strikt gegen das Muster geprueft und sonst geleert.
 */
final class ColorValidator
{
    ...
    /** Obergrenze für RAL-/Namens-Text, damit `order_line_item.custom_fields` nicht aufgeblaeht wird. */
     ...
     * einen leeren String (kein ungueltiger Wert wird je gespeichert/gerendert).
     */
    ...
    /**
     * Entfernt Markup und begrenzt die Laenge von Freitext-Feldern (RAL, Name).
     */
